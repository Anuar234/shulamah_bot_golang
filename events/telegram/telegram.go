...
import (
	"errors"
	"shulamah_bot_golang/clients/telegram"
	"shulamah_bot_golang/events"
...
func (p *Processor) Fetch(limit int) ([]events.Event, error) {
	...
	if err != nil {
		return nil, e.WrapIfErr("cant get events", err)
	}
...
func meta(event events.Event) (Meta, error) {
	...
	if !ok{
		return Meta{}, e.Wrap("cant get meta", ErrUnkownMetaType)
	}
